...
//        $this->setOrders();
    ...
    {
        if (isset($this->requestHandler->request->include)) {
           $this->requestHandler->setIncludes($this->model, $this);
        }
    ...
    {
        if (isset($this->requestHandler->request->filter)) {
            $this->requestHandler->setFilters($this);
        }
    ...
    {
        $this->requestHandler->setOrders($this->model, $this);
